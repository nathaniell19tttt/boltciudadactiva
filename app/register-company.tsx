...
export default function RegisterCompanyScreen() {
  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      if (existingRole && existingRole !== 'empresa') {
        setError('Este correo ya está registrado como trabajador. Usa otro correo.');
        return;
      }
      ...
      setRegistrationData({ email: email.trim().toLowerCase(), password, role: 'empresa' });
      router.push('/verify-email?role=empresa' as any);
    } catch (err: any) {
          ...
          <View style={styles.formContainer}>
            ...
            <Animated.View style={{ opacity: fadeAnim, transform: [{ translateY: slideAnim }] }}>
              ...
              <Text style={[styles.subtitle, { color: theme.colors.textSecondary }]}>
                Registra tu empresa y comienza a encontrar el mejor talento para tu negocio.
              </Text>
            </Animated.View>
